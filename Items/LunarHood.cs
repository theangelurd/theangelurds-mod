...
namespace theangelurdsmod.Items
{
	...
	public class LunarHood : ModItem
	{
		...
		{
			DisplayName.SetDefault("Lunar Hood"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
